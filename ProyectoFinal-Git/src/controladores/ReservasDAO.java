...
public class ReservasDAO {
    ...
    public static List<Integer> obtenerIDHuesped() {
        ...
        try (Connection con = ConexionBD.ObtenerConexion();
             PreparedStatement ps = con.prepareStatement("SELECT ID_Huesped FROM Huespedes");
    ...
    public static List<Integer> obtenerIdHabitacion() {
        List<Integer> lista = new ArrayList<>();
        try (Connection con = ConexionBD.ObtenerConexion();
             PreparedStatement ps = con.prepareStatement("SELECT Numero_Habitacion FROM Habitaciones");
             ResultSet rs = ps.executeQuery()) {
